	...
	$('#exampleTable')
			.bootstrapTable(
					...
					//	showColumns : true,
						...
						columns: [
							{checkbox: true},
							{field: 'stockNo', title: '仓库编号'},
							{field: 'stockName', title: '仓库名称'},
							...
							{field: 'updateTime', title: '修改时间'},
							{
								title: '操作', field: 'id', align: 'center', formatter: function (value, row, index) {
									return utils.renderButtons([
										{html: `<a class="btn btn-primary btn-sm" href="#" title="编辑" onclick="edit('${row.id}')"><i class="fa fa-edit"></i></a> `, perm: 'data:stock:edit'},
										{html: `<a class="btn btn-warning btn-sm" href="#" title="删除" onclick="remove('${row.id}')"><i class="fa fa-remove"></i></a> `, perm: 'data:stock:remove'},
									], row);
								}
							}]
					});

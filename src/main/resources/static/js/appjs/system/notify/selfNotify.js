                ...
                },
                {
                    ...
                    formatter: function (value, row, index) {
                        return utils.renderButtons([
                            {html: `<a class="btn btn-primary btn-sm" href="#" title="编辑" onclick="read('${row.id}')"><i class="fa fa-book"></i></a> `},
                            {html: `<a class="btn btn-warning btn-sm" href="#" title="删除" onclick="remove('${row.id}')"><i class="fa fa-remove"></i></a> `, perm: 'oa:notify:remove'},
                        ], row);
                    }
                }]
        });

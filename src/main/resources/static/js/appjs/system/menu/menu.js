    ...
    $('#exampleTable').bootstrapTreeTable(
        {
            ...
            columns: [
                ...
                {title: '名称', field: 'name'},
                {
                    title: '图标', field: 'icon', align: 'center', valign: 'middle', formatter: function (item, index) {
                        return item.icon == null ? '' : '<i class="' + item.icon + ' fa-lg"></i>';
                    }
                },
                {
                    title: '类型', field: 'type', align: 'center', valign: 'middle', formatter: function (item, index) {
                        if (item.type === 0) {
                ...
                {
                    title: '操作', field: 'id', align: 'center', formatter: function (item, row, index) {
